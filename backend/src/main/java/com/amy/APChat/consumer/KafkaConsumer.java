...
public class KafkaConsumer {
    ...
    public void foodChatListener(Message message) {
        System.out.println("(Topic: food) " + message.getSender() + "("+ message.getSenderId() + "): " + message.getContent());
    ...
    public void computerScienceChatListener(Message message) {
        System.out.println("(Topic: computer science) " + message.getSender() + "("+ message.getSenderId() + "): " + message.getContent());
    ...
    public void engineeringChatListener(Message message) {
        System.out.println("(Topic: engineering) " + message.getSender() + "("+ message.getSenderId() + "): " + message.getContent());
    ...
    public void mathChatListener(Message message) {
        System.out.println("(Topic: math) " + message.getSender() + "("+ message.getSenderId() + "): " + message.getContent());
    ...
    public void moviesChatListener(Message message) {
        System.out.println("(Topic: movies) " + message.getSender() + "("+ message.getSenderId() + "): " + message.getContent());
    ...
    public void sportsChatListener(Message message) {
        System.out.println("(Topic: sports) " + message.getSender() + "("+ message.getSenderId() + "): " + message.getContent());
